            ...
            <div className="navbar  flex justify-between  lg:max-w-[1340px] lg:m-auto ">
                <div className="cursor-pointer" onClick={() => navigate('/home')} >
                    <motion.a
                        ...
                        className="text-2xl">Meetup🔥</motion.a>
                </div>
                {/* searching box */}
                ...
                <section className='flex space-x-4 items-center'>
...

                    {
                        user ?
                            ...
                            (<div className="dropdown dropdown-center cursor-pointer relative">
                    ...
                    {!user ? (<div key={theme} className='space-x-2'>
                        <motion.button
                            // key={theme}
                            initial={{ opacity: 0, y: -10 }}
                            animate={{ opacity: 1, y: 0 }}
                            ...
                            className="btn btn-active btn-secondary rounded-lg" onClick={() => navigate('/auth', { state: { from: 'signin' } })}>Login</motion.button>
                        ...
                        <motion.button
                            ...
                            className="btn btn-active btn-success rounded-lg" onClick={() => navigate('/auth', { state: { from: 'signup' } })} >Registration</motion.button>
